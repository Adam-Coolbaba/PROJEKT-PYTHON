...
#TODO:
# 1)Poprawienie aplitudy (Może tylko zakres 0-1 albo trzeba robić przeskalowanie)
# 2)Poprawa funkcji down_action() (powinna pozwalać na ustawienie do 0)
...
a_x = EntryBox(entry_frame, "Amplituda 1", 1, update_graph)
a_y = EntryBox(entry_frame, "Amplituda 2", 1, update_graph)
f = EntryBox(entry_frame, "Rożnica faz", 1/2, update_graph)

t = np.arange(0, 100, 0.001)
x = a_x.value*np.sin(w_y.value*t)
y = a_y.value*np.sin(w_x.value*t + np.pi*f.value)
